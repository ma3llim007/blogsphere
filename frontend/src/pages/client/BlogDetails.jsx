...
const BlogDetails = () => {
    ...
    const blogTitle = slugToText(blogSlug);
    ...
    return (
        <>
            <Helmet>
                <title>{`${blogTitle} | BlogSphere - Discover Insights on Blogging`}</title>
                <meta name="description" content={`Read the full article to discover more insights, tips, and trends about ${blogTitle}.`} />
                <meta name="keywords" content={`${blogTitle}, Blog, BlogSphere`} />
                <meta name="author" content="BlogSphere Team" />
                <meta name="robots" content="index, follow" />
                <link rel="canonical" href={`${currentUrl}blog-details/${blogSlug}`} />
                {/* Open Graph / Facebook */}
                <meta property="og:title" content={`${blogTitle} | BlogSphere - Discover Insights on Blogging`} />
                <meta property="og:description" content={`Read the full article to discover more insights, tips, and trends about ${blogTitle}.`} />
