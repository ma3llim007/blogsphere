...
import { FaBlogger, FaCheckCircle, FaClipboardList, FaEdit, FaEnvelopeOpenText, FaFileAlt, FaFolderOpen, FaTimesCircle, FaUserEdit, FaUserShield } from "react-icons/fa";
...
const Dashboard = () => {
    ...
    const cardData = [
        { count: cards?.totalEnquiries, Icon: FaEnvelopeOpenText, label: "Total Enquiry", color: "text-white" },
        { count: cards?.totalModerators, Icon: FaUserShield, label: "Total Moderator", color: "text-white" },
        { count: cards?.totalWriters, Icon: FaUserEdit, label: "Total Writer", color: "text-white" },
        { count: cards?.totalCategories, Icon: FaFolderOpen, label: "Total Category", color: "text-white" },
        ...
        <>
            ...
            <section className="container mx-auto px-4 mb-10">
                ...
                <div className="w-full space-y-4">
                    ...
                    <div className="border border-gray-700 bg-gray-800 rounded p-4">
                        <h3 className="text-2xl font-bold underline mb-7">Blogs Category Status</h3>
