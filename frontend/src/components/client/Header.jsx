    ...
    return (
        <header className="container mx-auto flex items-center justify-between py-4  px-4 gap-8">
                    ...
                    <DropdownMenu>
                        <DropdownMenuTrigger asChild>
                            <div className="flex items-center gap-1">
                                <Link to={`/categories`} className="flex gap-1 cursor-pointer items-center outline-none" role="button" tabIndex={0} aria-haspopup="true" aria-expanded="false">
                                    Categories
                                </Link>
                                <DropdownMenuTrigger asChild>
            ...
            <div className="flex gap-4 items-center">
                ...
                <GoSidebarExpand className="lg:hidden" size={23} />
            </div>
        </header>
    );
};
